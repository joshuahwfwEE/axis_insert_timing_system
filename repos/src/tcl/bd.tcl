...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set clk_0 [ create_bd_port -dir I -type clk -freq_hz 74250000 clk_0 ]
  ...
  set_property CONFIG.C_ADDR_WIDTH {10} $v_vid_in_axi4s_0
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins axi_vip_0/aclk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/clk] [get_bd_pins v_tpg_0/ap_clk] [get_bd_pins v_vid_in_axi4s_0/aclk]
  connect_bd_net -net resetn_0_1 [get_bd_ports resetn_0] [get_bd_pins axi_vip_0/aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn] [get_bd_pins v_tpg_0/ap_rst_n] [get_bd_pins v_vid_in_axi4s_0/aresetn]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_s_axis_video_tready [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tready] [get_bd_pins v_tpg_0/m_axis_video_TREADY]
  ...
  connect_bd_net -net v_tpg_0_m_axis_video_TDATA [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tdata] [get_bd_pins v_tpg_0/m_axis_video_TDATA]
  connect_bd_net -net v_tpg_0_m_axis_video_TLAST [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tlast] [get_bd_pins v_tpg_0/m_axis_video_TLAST]
  connect_bd_net -net v_tpg_0_m_axis_video_TUSER [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tuser] [get_bd_pins v_tpg_0/m_axis_video_TUSER]
  connect_bd_net -net v_tpg_0_m_axis_video_TVALID [get_bd_pins v_axi4s_vid_out_0/s_axis_video_tvalid] [get_bd_pins v_tpg_0/m_axis_video_TVALID]
